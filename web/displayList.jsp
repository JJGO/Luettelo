<div class="component main-component">
    ...
    <c:if test="${displayList.username==sessionScope.user.username}">
        <a href="javascript:deleteList(${displayList.id})" style="float:right" class="check-icon" >
    ...
    <c:if test="${not empty sessionScope.user.username}">
        <c:if test="${not displayList.subscribed}">
            <a href="javascript:subscribeList(${displayList.id})" class="subscribe-icon" onmouseover="hoverSubscribe()" onmouseout="unhoverSubscribe()">
                <img src="images/subscribe.png" alt="Subscribe" id="subscribeIcon">
            </a>
        </c:if>
        <c:if test="${displayList.subscribed}">
            <a href="javascript:unsubscribeList(${displayList.id})" class="subscribe-icon" onmouseover="hoverUnsubscribe()" onmouseout="unhoverUnsubscribe()">
                <img src="images/subscribed.png" alt="Subscribe" id="subscribeIcon">
            </a>
        </c:if>
    </c:if>
    <c:if test="${displayList.username==sessionScope.user.username}">
        <form onsubmit="javascript:commitEditList(${displayList.id})" class="list-margin component-title" style="display:none" id="list-edit">
            <table>
                <tr>
                    <td>Name</td>
